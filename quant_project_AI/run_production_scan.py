...
def main():
    ...
    if args.phase == 0 or args.phase == 2:
        if args.phase >= 2 and not phase1_ranking:
            print("WARNING: Phase 1 results not found. Run --phase 1 first.")
            sys.exit(1)
    ...
    if args.phase == 0 or args.phase == 3:
        if args.phase >= 3 and (not phase1_ranking or not phase2_ranking):
            print("WARNING: Phase 1 and/or Phase 2 results not found. Run --phase 1 and --phase 2 first.")
            sys.exit(1)
    ...
    if args.phase == 0 or args.phase == 4:
        if args.phase >= 4 and (not phase1_ranking or not phase2_ranking):
            print("WARNING: Phase 1 and/or Phase 2 results not found. Run --phase 1 and --phase 2 first.")
            sys.exit(1)
