import numpy as np
from quant_framework.backtest.kernels import eval_kernel, DEFAULT_PARAM_GRIDS, KERNEL_NAMES, config_to_kernel_costs
...
for name in KERNEL_NAMES:
    ...
    r, d, t = eval_kernel(name, params, close, open_, high, low,
